...
CompoundAmount = ...
MERGE_COST = ...
def valid_account_regexp(options): # -> Pattern[str]:
...
class Builder(lexer.LexBuilder):
    ...
    def finalize(self): # -> tuple[list[Any], list[Any], dict[Any, Any]]:
    ...
    def store_result(self, filename, lineno, entries): # -> None:
    ...
    def build_grammar_error(self, filename, lineno, exc_value, exc_type=..., exc_traceback=...): # -> None:
    ...
    def pipe_deprecated_error(self, filename, lineno): # -> None:
    ...
    def pushtag(self, filename, lineno, tag): # -> None:
    ...
    def poptag(self, filename, lineno, tag): # -> None:
    ...
    def pushmeta(self, filename, lineno, key_value): # -> None:
    ...
    def popmeta(self, filename, lineno, key): # -> None:
    ...
    def option(self, filename, lineno, key, value): # -> None:
    ...
    def include(self, filename, lineno, include_filename): # -> None:
    ...
    def plugin(self, filename, lineno, plugin_name, plugin_config): # -> None:
    ...
    def amount(self, filename, lineno, number, currency): # -> Amount:
    ...
    def compound_amount(self, filename, lineno, number_per, number_total, currency): # -> CompoundAmount:
        """Process an amount grammar rule.
    ...
    def cost_merge(self, filename, lineno, _): # -> Literal['***']:
        """Create a 'merge cost' token."""
        ...
    
    def cost_spec(self, filename, lineno, cost_comp_list, is_total): # -> CostSpec:
    ...
    def handle_list(self, filename, lineno, object_list, new_object): # -> list[Any]:
    ...
    def custom_value(self, filename, lineno, value, dtype=...): # -> ValueType:
    ...
    def key_value(self, filename, lineno, key, value): # -> KeyValue:
        """Process a document directive.
    ...
    def posting(self, filename, lineno, account, units, cost, price, istotal, flag): # -> Posting:
    ...
    def tag_link_new(self, filename, lineno): # -> TagsLinks:
    ...
    def transaction(self, filename, lineno, date, flag, txn_strings, tags_links, posting_or_kv_list): # -> None:
