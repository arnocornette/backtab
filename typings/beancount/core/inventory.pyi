...
class Inventory(dict):
    ...
    def __mul__(self, scalar): # -> Inventory:
    ...
    def add_amount(self, units, cost=...): # -> tuple[Any | None, Literal[Booking.REDUCED, Booking.AUGMENTED, Booking.IGNORED, Booking.CREATED]]:
    ...
    def add_position(self, position): # -> tuple[Any | None, Literal[Booking.REDUCED, Booking.AUGMENTED, Booking.IGNORED, Booking.CREATED]]:
