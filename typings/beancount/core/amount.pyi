...
class Amount(_Amount):
    ...
    def __new__(cls, number, currency): # -> Self:
    ...
    def to_string(self, dformat=...): # -> str:
...
def sortkey(amount): # -> tuple[Any, Any]:
...
def add(amount1, amount2): # -> Amount:
...
def sub(amount1, amount2): # -> Amount:
