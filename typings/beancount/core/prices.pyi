...
def get_latest_price(price_map, base_quote): # -> tuple[None, Decimal] | tuple[None, None]:
...
def get_price(price_map, base_quote, date=...): # -> tuple[None, Decimal] | tuple[None, None]:
