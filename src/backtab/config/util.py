...
def get_config(config_path: str) -> Config:
    match config_type:
        ...
        # retur
        case "json":
            return JsonConfig.load(path=config_path)
        case _:
            raise UpdateFailed()
...
backtab_config = get_config(config_path)
